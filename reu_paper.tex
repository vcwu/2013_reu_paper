...
A conflict is detected if the relative velocity vector lies within the collision cone. Mathematically, a conflict occurs if \begin{math}\beta <  \alpha \end{math} where:
\newline
 \centerline{\begin{math} \beta = \ \angle\overrightarrow{v}  - \angle\overrightarrow{r}, \end{math}}
\newline
and
\newline
\centerline{\begin{math}\alpha = \arcsin(\frac{dsep}{||\overrightarrow{r}||)}\end{ math}}
