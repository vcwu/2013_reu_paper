...
A conflict is detected if the relative velocity vector lies within the collision cone. Mathematically, a conflict is detected when 

\beta < \alpha
\newline
where
\newline
\beta = \angle v - \angle r
...
\begin{figure*}
	\label{fig:06Round}
	\includegraphics [
scale=0.25]{2006Pallotino}
	
	\caption{Illustrates the reserved disc concept for a single UAV
}
\end{figure*}
